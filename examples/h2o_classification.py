...
def main():
    ...
    test_file_store_response = c.store('../csv/rg_test.csv')
    print(test_file_store_response)
    test_data = test_file_store_response['fileUrl']
    train_data_store_response = c.store('../csv/rg_train.csv')
    ...
    feedback_data_store_response = c.store('../csv/rg_feedback.csv')
