...
def main():
    ...
    train_response = c.train("classification", "NaiveBayesMultinomial", train_data, "player_activity",
                             ["stamina", "challenges", "achievements"], "Player Churn Model", "weka", 80, True)
    ...
    feedback_response = c.feedback("classification", "NaiveBayesMultinomial", train_data, feedback_data, job_id, model,
                                   "player_activity", ["stamina", "challenges", "achievements"], "weka",
                                   "Player Churn Model", 80, True)
